...
export function registerAuthTools(server) {
    server.tool("auth_login", "Đăng nhập lấy token. Gọi khi user yêu cầu đăng nhập hoặc thiếu token.", {
        ...
        const result = await callFakeServer("auth_login", "POST", "/login", undefined, args);
